Template EnginesEJS (Embedded JavaScript Templates)
...
Next, our server needs to know how to handle HTML files that are formatted using ejs, so near the top of our code (after we define our "app"), add the line:
